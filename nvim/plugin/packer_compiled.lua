...
_G.packer_plugins = {
  ...
  catppuccin = {
    ...
    loaded = true,
    path = "/home/samuzora/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  neotest = {
    config = { 'setup("neotest")' },
    loaded = true,
    path = "/home/samuzora/.local/share/nvim/site/pack/packer/start/neotest",
    url = "https://github.com/nvim-neotest/neotest"
  },
  ["neotest-python"] = {
    loaded = true,
    path = "/home/samuzora/.local/share/nvim/site/pack/packer/start/neotest-python",
  ...
  ["nvim-dap"] = {
    config = { 'setup("dap")' },
    loaded = true,
    path = "/home/samuzora/.local/share/nvim/site/pack/packer/start/nvim-dap",
  ...
  ["vim-mdx"] = {
    loaded = true,
    path = "/home/samuzora/.local/share/nvim/site/pack/packer/start/vim-mdx",
